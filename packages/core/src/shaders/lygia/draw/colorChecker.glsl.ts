// generated from projects/poca-card/src/lib/v2/shaders/lygia/draw/colorChecker.glsl
export default `#include <lygia/space/scale>
#include <lygia/color/palette/macbeth>
#include <lygia/color/palette/spyder>
#include <lygia/sdf/crossSDF>
#include <lygia/draw/rect>
