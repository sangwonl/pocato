// generated from projects/poca-card/src/lib/v2/shaders/lygia/distort/grain.glsl
export default `#include <lygia/generative/snoise>
#include <lygia/generative/pnoise>
#include <lygia/color/luma>
#include <lygia/color/blend/softLight>
