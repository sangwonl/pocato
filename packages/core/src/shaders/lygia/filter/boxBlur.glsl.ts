// generated from projects/poca-card/src/lib/v2/shaders/lygia/filter/boxBlur.glsl
...
#include <lygia/filter/boxBlur/1D>
#include <lygia/filter/boxBlur/2D>
#include <lygia/filter/boxBlur/2D_fast9>
