// generated from projects/poca-card/src/lib/v2/shaders/lygia/filter/bilateral.glsl
export default `#include <lygia/math/gaussian>
#include <lygia/color/space/rgb2luma>
