// generated from projects/poca-card/src/lib/v2/shaders/lygia/filter/edge.glsl
export default `#include <lygia/sample/clamp2edge>
...
#include <lygia/filter/edge/prewitt>
#include <lygia/filter/edge/sobel>
#include <lygia/filter/edge/sobelDirectional>
