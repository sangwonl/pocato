// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/common/specularAO.glsl
export default `// See section 4.10.2 in Sebastien Lagarde: Moving Frostbite to Physically Based Rendering 3.0
