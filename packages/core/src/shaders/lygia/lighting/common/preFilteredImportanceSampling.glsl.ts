// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/common/preFilteredImportanceSampling.glsl
export default `#ifndef FNC_PRE_FILTERED_IMPORTANCE_SAMPLING
