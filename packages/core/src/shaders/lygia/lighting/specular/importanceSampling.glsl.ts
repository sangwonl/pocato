// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/specular/importanceSampling.glsl
export default `#include <lygia/math/hammersley>
#include <lygia/math/rotate3dZ>
#include <lygia/space/tbn>
#include <lygia/generative/random>
#include <lygia/lighting/common/ggx>
#include <lygia/lighting/common/smithGGXCorrelated>
#include <lygia/lighting/fresnel>
#include <lygia/lighting/common/preFilteredImportanceSampling>
