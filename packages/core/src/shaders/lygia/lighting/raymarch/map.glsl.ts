// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/raymarch/map.glsl
export default `#include <lygia/lighting/material>
#include <lygia/lighting/medium>
