// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/pbrClearCoat.glsl
export default `#include <lygia/math/saturate>
#include <lygia/color/tonemap>

#include <lygia/lighting/common/ggx>
#include <lygia/lighting/common/kelemen>

#include <lygia/lighting/shadingData/new>
#include <lygia/lighting/material>
#include <lygia/lighting/envMap>
#include <lygia/lighting/fresnelReflection>
#include <lygia/lighting/sphericalHarmonics>
#include <lygia/lighting/light/new>
#include <lygia/lighting/light/resolve>

#include <lygia/lighting/reflection>
#include <lygia/lighting/common/specularAO>
#include <lygia/lighting/common/envBRDFApprox>

#include <lygia/lighting/ior/2f0>
