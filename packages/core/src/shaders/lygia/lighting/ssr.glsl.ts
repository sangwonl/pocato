// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/ssr.glsl
export default `
#include <lygia/space/view2screenPosition>
#include <lygia/sdf/lineSDF>
#include <lygia/sdf/planeSDF>
