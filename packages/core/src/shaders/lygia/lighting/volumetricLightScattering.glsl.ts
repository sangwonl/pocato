// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/volumetricLightScattering.glsl
export default `#include <lygia/math/const>
#include <lygia/math/inverse>
#include <lygia/space/screen2viewPosition>
#include <lygia/space/depth2viewZ>
