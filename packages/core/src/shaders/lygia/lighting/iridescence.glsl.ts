// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/iridescence.glsl
export default `#include <lygia/color/palette/hue>
#include <lygia/color/space/w2rgb>
