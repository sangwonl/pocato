// generated from projects/poca-card/src/lib/v2/shaders/lygia/lighting/light/new.glsl
export default `#include <lygia/lighting/light/directional>
#include <lygia/lighting/light/point>
