// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/daltonize.glsl
export default `#include <lygia/color/space/rgb2lms>
#include <lygia/color/space/lms2rgb>
