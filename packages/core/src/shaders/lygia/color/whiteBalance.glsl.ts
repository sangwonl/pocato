// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/whiteBalance.glsl
export default `#include <lygia/color/space/rgb2yiq>
#include <lygia/color/space/yiq2rgb>
