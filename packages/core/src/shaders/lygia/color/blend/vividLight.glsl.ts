// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/blend/vividLight.glsl
export default `#include <lygia/color/blend/colorBurn>
#include <lygia/color/blend/colorDodge>
