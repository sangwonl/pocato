// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/blend/pinLight.glsl
export default `#include <lygia/color/blend/lighten>
#include <lygia/color/blend/darken>
