// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/blend/linearLight.glsl
export default `#include <lygia/color/blend/linearDodge>
#include <lygia/color/blend/linearBurn>
