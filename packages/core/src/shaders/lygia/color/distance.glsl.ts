// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/distance.glsl
export default `#include <lygia/color/space/rgb2lab>
#include <lygia/color/space/rgb2YCbCr>
#include <lygia/color/space/rgb2YPbPr>
#include <lygia/color/space/rgb2yuv>
