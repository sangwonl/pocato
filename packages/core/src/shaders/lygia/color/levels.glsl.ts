// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/levels.glsl
export default `#include <lygia/color/levels/inputRange>
#include <lygia/color/levels/outputRange>
#include <lygia/color/levels/gamma>
