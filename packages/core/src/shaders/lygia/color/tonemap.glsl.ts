// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/tonemap.glsl
export default `#include <lygia/color/tonemap/aces>
#include <lygia/color/tonemap/debug>
#include <lygia/color/tonemap/filmic>
#include <lygia/color/tonemap/linear>
#include <lygia/color/tonemap/reinhard>
#include <lygia/color/tonemap/reinhardJodie>
#include <lygia/color/tonemap/uncharted>
#include <lygia/color/tonemap/uncharted2>
