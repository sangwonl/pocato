// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/layer/luminositySourceOver.glsl
...
vec4 layerLuminositySourceOver(vec4 src, vec4 dest) {
    vec4 result = vec4(0.0, 0.0, 0.0, 0.0);

    // Compute luminosity for RGB channels
    vec3 blendedColor = blendLuminosity(src.rgb, dest.rgb);
