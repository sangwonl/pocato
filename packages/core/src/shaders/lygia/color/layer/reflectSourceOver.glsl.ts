// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/layer/reflectSourceOver.glsl
...
use: <vec4> layerReflectSourceOver(<vec4> src, <vec4> dst)
license:
    - Copyright (c) 2021 Patricio Gonzalez Vivo under Prosperity License - https://prosperitylicense.com/versions/3.0.0
    - Copyright (c) 2021 Patricio Gonzalez Vivo under Patron License - https://lygia.xyz/license
*/

#ifndef FNC_LAYER_REFLECT_SRC_OVER
#define FNC_LAYER_REFLECT_SRC_OVER

vec4 layerReflectSourceOver(vec4 src, vec4 dest) {
