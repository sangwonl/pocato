// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/layer/hardLightSourceOver.glsl
...
use: <vec4> layerHardLightSourceOver(<vec4> src, <vec4> dst)
license:
...
vec4 layerHardLightSourceOver(vec4 src, vec4 dest) { 
