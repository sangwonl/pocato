// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/layer/linearDodgeSourceOver.glsl
...
use: <vec4> layerLinearDodgeSourceOver(<vec4> src, <vec4> dst)
license:
