// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/hueShift.glsl
export default `#include <lygia/color/space/hsl2rgb>
#include <lygia/color/space/rgb2hsl>
