// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/palette/spectral.glsl
export default `#include <lygia/color/palette/spectral/gems>
#include <lygia/color/palette/spectral/geoffrey>
#include <lygia/color/palette/spectral/soft>
#include <lygia/color/palette/spectral/zucconi>
#include <lygia/color/palette/spectral/zucconi6>
