// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/space/rgb2hcy.glsl
export default `#include <lygia/color/space/rgb2hcv>
#include <lygia/color/space/hue2rgb>
