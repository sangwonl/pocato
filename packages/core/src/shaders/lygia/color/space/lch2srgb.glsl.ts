// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/space/lch2srgb.glsl
export default `#include <lygia/color/space/lch2lab>
#include <lygia/color/space/lab2srgb>
/*
