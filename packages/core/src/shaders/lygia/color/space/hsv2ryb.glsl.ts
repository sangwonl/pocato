// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/space/hsv2ryb.glsl
export default `#include <lygia/color/space/hsv2rgb>
#include <lygia/color/space/rgb2ryb>
#include <lygia/color/space/ryb2rgb>
