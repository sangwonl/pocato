// generated from projects/poca-card/src/lib/v2/shaders/lygia/color/space/srgb2lch.glsl
export default `#include <lygia/color/space/rgb2lch>
#include <lygia/color/space/srgb2rgb>
