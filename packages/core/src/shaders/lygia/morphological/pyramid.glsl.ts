// generated from projects/poca-card/src/lib/v2/shaders/lygia/morphological/pyramid.glsl
export default `// POISSON FILL (DEFAULT)
...
#include <lygia/morphological/pyramid/downscale>
#include <lygia/morphological/pyramid/upscale>
