// generated from projects/poca-card/src/lib/v2/shaders/lygia/morphological/alphaHashing.glsl
export default `#include <lygia/morphological/lygia/generative/random>
