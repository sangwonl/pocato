// generated from projects/poca-card/src/lib/v2/shaders/lygia/sample/3DSdf.glsl
export default `#include <lygia/sample/2DCube>
#include <lygia/space/scale>
#include <lygia/sdf/boxSDF>
#include <lygia/sdf/opIntersection>
