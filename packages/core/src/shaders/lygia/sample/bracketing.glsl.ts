// generated from projects/poca-card/src/lib/v2/shaders/lygia/sample/bracketing.glsl
export default `#include <lygia/space/rotate>
#include <lygia/space/bracketing>
