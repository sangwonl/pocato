// generated from projects/poca-card/src/lib/v2/shaders/lygia/sample/equirect.glsl
export default `#include <lygia/space/xyz2equirect>
#include <lygia/generative/random>
#include <lygia/generative/srandom>
#include <lygia/sampler>

#include <lygia/color/space/linear2gamma>
#include <lygia/color/space/gamma2linear>
/*
